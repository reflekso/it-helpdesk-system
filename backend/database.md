...
| role | VARCHAR(10) | Да | Роль пользователя в системе (ENUM Admin, Auditor, Employee, Specialist) |
...
| message_from | VARCHAR(10) | Да | Отправитель сообщения (ENUM "Employee", "Specialist") |
